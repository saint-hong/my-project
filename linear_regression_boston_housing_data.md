...
### 분석목적 3 "선형회귀 분석 방법을 사용하여 회귀 모델의 성능을 개선하기 위한 모델링을 적용"의 
...
- 또한 분석 과정에서 선형회귀 이론의 부족한 부분이나 직접 작성한 코드의 문제점들이 발생한 경우 인터넷 검색을 활용하여 관련 자료들을 찾고, 재적용 해봄으로써 개선하였다.
...
- 또한 어떤 현상에 대해 기대하는 나의 경험적 지식과 그 현상을 수치화한 데이터의 분석결과가 일치하지 않을 수 있다는 것을 알 수 있었다. 일반적으로 과학적 분석의 결과를 좀 더 신뢰할 수 있겠지만 경험적 지식과 분석적 지식의 불일치를 어떻게 해석하느냐에 따라서 두 지식을 적절하게 조화시킬 수 있을 것이라고 생각해 보았다. 
