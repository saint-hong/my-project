...
- 최종 모델 m_10의 분포
    ...
    - 양의 잔차가 큰 것은 주로 종속값 15~35에 해당하는 데이터이고, 음의 잔차가 큰 것은 주로 종속값 5~25에 해당하는 데이터들이다.
...
- 최종 모델의 유의확률
    - False : RAD(6, 2), DIS(2차), NOX(1차, 2차), ZN(1, 2차), RM(6), INDUS(1차), CRIM(3차)
    - True : False를 제외한 나머지 독립변수
