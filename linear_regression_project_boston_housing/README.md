...
### 2-4. (프로젝트 결과 1-4-5) 최종 모델의 예측 가중치에 따른 집값 변화량
- **집값 상승에 영향을 미치는 요인**
...
### 2-5. (프로젝트 결과 1-6) 최초 모델과 최종 모델의 잔차의 정규성 검정 : QQ플롯 비교
...
### 2-6. (프로젝트 결과 2) 가설 2 "집값을 증가, 감소 시키는 가장 큰 요인 3가지"의 검증 
- 집값을 증가시키는 요인
